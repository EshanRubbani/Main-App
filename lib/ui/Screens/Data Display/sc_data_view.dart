...
class MySCTableScreen extends StatefulWidget {
  const MySCTableScreen({Key? key}) : super(key: key);

  @override
  State<MySCTableScreen> createState() => _MySCTableScreenState();
}

class _MySCTableScreenState extends State<MySCTableScreen> {
  List<msg> messages = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Snapchat Notification History',

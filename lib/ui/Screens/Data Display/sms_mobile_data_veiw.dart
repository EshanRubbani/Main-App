...
class MySMSTableScreen extends StatefulWidget {
  const MySMSTableScreen({Key? key}) : super(key: key);

  @override
  State<MySMSTableScreen> createState() => _SMSMyTableScreenState();
}

class _SMSMyTableScreenState extends State<MySMSTableScreen> {
  List<msg> messages = [];
